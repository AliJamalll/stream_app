...
class _VideoCallScreenState extends State<VideoCallScreen> {
  // Replace these with your actual GetStream.io credentials
  static const String apiKey = 'mmhfdzb5evj2';  // Test API key
  ...
  Future<void> _initializeVideoCall() async {
    try {
      ...
      // Initialize StreamVideo with test credentials
      final user = User(
        info: UserInfo(
          id: userId,
